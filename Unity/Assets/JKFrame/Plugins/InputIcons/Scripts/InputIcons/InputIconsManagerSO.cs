...
namespace InputIcons
{
    ...
    public class InputIconsManagerSO : ScriptableObject
    {
        ...
        public void InitializePlayerInput()
        {
            ...
            {
                GameObject pInputObject = new GameObject("II_PlayerInput");
        ...
        public void CreateInputStyleData()
        {
            ...
            {
                Debug.LogWarning("InputIconSetConfigurator Instance was null, please try again.");
                return;
            }

            CreateKeyboardInputStyleData(InputIconSetConfiguratorSO.Instance.keyboardIconSet.deviceDisplayName);
            ...
            CreateGamepadInputStyleData(gamepadIconSet.deviceDisplayName);
        ...
        public void UpdateInputStyleData()
        {
            ...
            if (iconSet.GetType() == typeof(InputIconSetKeyboardSO))
            {
                ...
                {
                    CreateKeyboardInputStyleData(iconSet.deviceDisplayName);
                    inputStyleKeyboardDataList = GetCleanedUpStyleList(inputStyleKeyboardDataList);
                }
            ...
            if (iconSet.GetType() == typeof(InputIconSetGamepadSO))
            {
                ...
                {
                    CreateGamepadInputStyleData(iconSet.deviceDisplayName);
                    inputStyleGamepadDataList = GetCleanedUpStyleList(inputStyleGamepadDataList);
                }
            }
